...
// metric is agg:[interval-agg:][rate:]metric[{tag=value,...}]
  final public String METRIC() throws ParseException {
                       Token agg,itvl,rate,metric,tagk,tagv; StringBuilder builder = new StringBuilder();
    ...
    if (jj_2_8(2)) {
      ...
      ;
                              ...
                              if (tagPairs.size() > 0) builder.append("{").append(JOINER.join(tagPairs)).append("}"); {if (true) return builder.toString();}
    throw new Error("Missing return statement in function");
  }
